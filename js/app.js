    ...
    history: `
        <div class="view active" id="view-history">
            ...
            <div class="flex-between" style="margin-bottom: 1rem; align-items: center;">
                <h2 style="font-size: 1.1rem; margin-bottom: 0; color: var(--text-muted); white-space: nowrap;">Past Transactions</h2>
                ...
                <div style="display: flex; gap: 12px; align-items: center; padding-right: 8px; flex-shrink: 0;">
